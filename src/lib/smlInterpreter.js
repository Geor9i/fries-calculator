import {
  ...
  import { SmlElement } from "./smlElement.js";
   class SMLInterpreter {
    ...
    interpret(htmlString) {
        console.log(htmlString);
        let buffer = '';
        let stringIndex = 0;
        while(stringIndex < htmlString.length) {
            buffer += htmlString[stringIndex]
            stringIndex++
        } 
        console.log(buffer);
    }
  ...
  export const smlInterpreter = new SMLInterpreter();
